...
plantilla 1
deuda: cotizaciones
equipo interno: 4.333
equipo judicial: 8.988
equipo stock: 154.610
equipo otros: 0
...
BEGIN   
 ...
 BEGIN  
  ...
  --BEGIN  
  -- IF @NOMBRE_VALOR LIKE '%1%'  
  --  SET @sqlfiltro = CASE WHEN @sqlfiltro = '' THEN ' and equipo_cobrador = ''INTERNO'' ' ELSE @sqlfiltro + ' and equipo_cobrador = ''INTERNO'' ' END  
  -- IF @NOMBRE_VALOR LIKE '%2%'  
  --  SET @sqlfiltro = CASE WHEN @sqlfiltro = '' THEN ' and equipo_cobrador = ''STOCK'' ' ELSE @sqlfiltro + ' and equipo_cobrador = ''STOCK'' ' END  
  -- IF @NOMBRE_VALOR LIKE '%3%'  
  --  SET @sqlfiltro = CASE WHEN @sqlfiltro = '' THEN ' and equipo_cobrador = ''JUDICIAL'' ' ELSE @sqlfiltro + ' and equipo_cobrador = ''JUDICIAL'' ' END  
  -- IF @NOMBRE_VALOR LIKE '%4%'  
  --  SET @sqlfiltro = CASE WHEN @sqlfiltro = '' THEN ' and equipo_cobrador = ''OTROS'' ' ELSE @sqlfiltro + ' and equipo_cobrador = ''OTROS'' ' END  
