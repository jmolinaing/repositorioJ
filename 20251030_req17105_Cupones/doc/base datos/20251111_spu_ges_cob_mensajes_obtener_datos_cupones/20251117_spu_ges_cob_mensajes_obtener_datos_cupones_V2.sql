        ...
        BEGIN TRANSACTION
			...
			BEGIN TRY
					...
					select
						...
						, tdc.DEC_RUT	--,<COT_RUT, char(10),>
						, SUBSTRING(tf.nombre_deudor, 1, 25)  -- ,<NOM_COTIZANTE, varchar(25),>
						, tdc.DEC_RUT			--   ,<EPA_RUT, char(10),>							--jmolina: afinar **********************OBLIGATORIO EN EL OTRO SP
						, NULL			--   ,<EPA_RAZON, varchar(200),>
						...
						, tdc.DEC_DEUDA		--   ,<DEUDANOMINAL, numeric(10,0),>						--jmolina: afinar **********************OBLIGATORIO EN EL OTRO SP
						...
						, NULL		--   ,<DESCTO_REAJUSTE, numeric(10,0),>
						, NULL		--   ,<DESCTO_INTERES, numeric(10,0),>
						, NULL		--   ,<DESCTO_RECARGO, numeric(10,0),>)
			...
			BEGIN TRY
					...
					EXECUTE [MIRROR_NT].[AGENCIAS].[DBO].spu_ges_cob_mensajes_generar_cupones @getdate;
			END TRY
					BEGIN CATCH
						IF @@TRANCOUNT > 0
							ROLLBACK
