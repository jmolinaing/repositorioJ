...
BEGIN	
	...
	--REVISAR SI EXISTE WHERE, SI NO LO HAY NO SE PODRA EJECUTAR EL PROCESO
	IF ISNULL(@sqlwhere, '') = '' 
	BEGIN
	...
	BEGIN
			...
			--select * from #cobrador_asig_cotiz		--15 reg en 0 seg
	END
	...
	BEGIN
			...
			--select * from #cobrador_asig_lurchq		--15 reg en 0 seg
	...
	SET 
		...
		, deuda_lur_con_credito = dlcc.deuda_lur_con_credito
 		, cob_codigo = cob_cotiz.cob_codigo		
	...
	--, fono_contacto
	--, [dbo].[f_get_datocontacto](rut_deudor,''email'') AS email_destinatario

	--desarrollo
	-- sin f_get_datocontacto y top 10.000  1:45 min
	-- con f_get y top 10.000  7.31 min

	--55
	-- sin f_get_datocontacto y top 10.000  2min planilla 8 9.242 reg
	-- con f_get y top 10.000 planilla 8 2:33min 9,242
