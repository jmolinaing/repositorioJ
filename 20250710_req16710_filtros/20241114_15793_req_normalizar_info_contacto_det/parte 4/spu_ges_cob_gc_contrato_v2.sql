...
-- FECHA MODIFICACION : 08-01-2025  
-- DESCRIPCION        : Se agrega funcion f_get_datocontacto para sacar los datos de direccion en el select

/* =======================================================================================*/    

--execute spu_ges_cob_gc_contrato '  28065396', '  28065396'  

ALTER PROCEDURE [dbo].[spu_ges_cob_gc_contrato]   
 @as_rut char(10),  
 ...
 IF @cot_rut is not null  
  BEGIN  
   ...
   SELECT  C.CON_FOLIO,  
	...
	dbo.f_get_datocontacto(@cot_rut, 'direccion') DDR_DIRECCION, 
 ...
 ELSE  
  BEGIN  
   SELECT  NULL AS CON_FOLIO,  
	...
	dbo.f_get_datocontacto(@as_rut, 'direccion') DDR_DIRECCION, 
