...
--UPDATE a
--set ctd_email1_v2 = replace(b.ctd_email1, ' ', '')
--FROM #CONTACTO_DET_NEW_V0 as a
--join #CONTACTO_DET_NEW_V0 as b 
--	on a.cto_rut = b.cto_rut 
--	and a.ctd_correl = b.ctd_correl
--where b.ctd_email1 is not null

----hasta aqui
----1.047.078 reg 3:55 min

--UPDATE a
--set ctd_email2_v2 = replace(b.ctd_email2, ' ', '')
--FROM #CONTACTO_DET_NEW_V0 as a
--join #CONTACTO_DET_NEW_V0 as b 
--	on a.cto_rut = b.cto_rut 
--	and a.ctd_correl = b.ctd_correl
--where b.ctd_email2 is not null
...
--select * from contacto_det where cto_rut = ' 99599500K'
