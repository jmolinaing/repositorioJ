       ...
       --@TipoDeudor --Valores: VIGENTE, NOVIGENTE, EMPRESA    
        ...
        -- select * from #periodo_descuentos    
             ...
             select    
              ...
              , CONVERT(NUMERIC(15),tdc.DEC_DEUDA * pd.DESCTO_DEUDANOMINAL / 100)   --<DESCTO_DEUDANOMINAL, numeric(10,0),>   MODIFICAR CON EL ALIAS DE LA TABLA DE DESCUENTOS    
              , CONVERT(NUMERIC(15),tdc.REAJUSTE * pd.DESCTO_REAJUSTE / 100)   --   ,<DESCTO_REAJUSTE, numeric(10,0),>     
              , CONVERT(NUMERIC(15),tdc.INTERES * pd.DESCTO_INTERES / 100)   --   ,<DESCTO_INTERES, numeric(10,0),>   
              , CONVERT(NUMERIC(15),tdc.RECARGO * pd.DESCTO_RECARGO / 100)   --   ,<DESCTO_RECARGO, numeric(10,0),>)     
             FROM #TMP_DEUDA_COTIZANTE tdc    
             join #tabla_final_filtrada tf on tdc.dec_rut = tf.rut_deudor    
