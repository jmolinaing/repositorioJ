/*========================================================================================     
 ...
 descripción  : Req_#17514:
                1) Se agrega #periodo_descuentos para el @TipoDeudor: VIGENTE, NOVIGENTE, EMPRESA  
                para el calculo de DESCTO_DEUDANOMINAL , DESCTO_REAJUSTE , DESCTO_INTERES , DESCTO_RECARGO
                2) Se modifica calculo @ult_periodo_cc Periodo Contable cerrado.
                3) Se agrega parametro de entrada @descuentos
...
--EJ3: Plantilla:20, Filtros: , SOLO GENERACION DE CUPONES, CON DESCUENTOS  
execute spu_ges_cob_mensajes_obtener_datos 2, 'N', NULL, NULL, 'S', 'S'  --4577 REG, 1,35MIN con su url_link y cup_correl OK  
...
BEGIN  
 ...
 CREATE TABLE #tabla_cupones (  
  ...
  CREATE TABLE #periodo_descuentos (    
      periodo datetime null
    , DESCTO_DEUDANOMINAL numeric(10) null 
    , DESCTO_REAJUSTE numeric(10) null 
    , DESCTO_INTERES numeric(10) null 
    , DESCTO_RECARGO numeric(10) null 
 );  
    ...
    BEGIN  
        ...
        IF @descuentos = 'S'
        BEGIN
               insert into #periodo_descuentos (periodo, DESCTO_DEUDANOMINAL, DESCTO_REAJUSTE, DESCTO_INTERES, DESCTO_RECARGO)
       ...
       --@TipoDeudor --Valores: VIGENTE, NOVIGENTE, EMPRESA  
        ...
        -- select * from #periodo_descuentos  
             ...
             select  
              ...
              , coalesce(CONVERT(NUMERIC(15),tdc.DEC_DEUDA * pd.DESCTO_DEUDANOMINAL / 100), 0)   --MODIFICAR CON EL ALIAS DE LA TABLA DE DESCUENTOS  
              , coalesce(CONVERT(NUMERIC(15),tdc.DEC_DEUDA * pd.DESCTO_REAJUSTE / 100), 0)   --   ,<DESCTO_REAJUSTE, numeric(10,0),>  
              , coalesce(CONVERT(NUMERIC(15),tdc.DEC_DEUDA * pd.DESCTO_INTERES / 100), 0)   --   ,<DESCTO_INTERES, numeric(10,0),>  
              , coalesce(CONVERT(NUMERIC(15),tdc.DEC_DEUDA * pd.DESCTO_RECARGO / 100), 0)   --   ,<DESCTO_INTERES, numeric(10,0),>)  
             FROM #TMP_DEUDA_COTIZANTE tdc  
             join #tabla_final_filtrada tf on tdc.dec_rut = tf.rut_deudor  
