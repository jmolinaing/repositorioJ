...
CREATE PROCEDURE [dbo].[spu_ges_cob_cju_ges_deuda] @p_cod_cob numeric(4), @p_ind_rjud char(1)  , @excluir_mediatica char(1) = null, @excluir_quiebra char(1) = null, @excluir_venta char(1) = null  
AS    
BEGIN     
 SET NOCOUNT ON;    
