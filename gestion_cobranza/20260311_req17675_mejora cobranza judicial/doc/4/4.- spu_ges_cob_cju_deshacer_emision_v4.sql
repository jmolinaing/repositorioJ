...
DESCRIPCIÓN        : Tareas #17675: Permita validar si la RJ puede ser dejada nuevamente en estado pendiente.
 ...
 */
    ...
    SET @estado_resolucion = dbo.f_ges_cob_estado_resoljud(@rej_folio);
    ...
    if @estado_resolucion in ('ANULADA' ,'RECAUDADA','PENDIENTE')
    begin 
        SET @error_code = -1;
        SET @error_msg = 'No se puede: resolución '+@estado_resolucion;
    end
    ELSE
    BEGIN
        BEGIN TRANSACTION;
