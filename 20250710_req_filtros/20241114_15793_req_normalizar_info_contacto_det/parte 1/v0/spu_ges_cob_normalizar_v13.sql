...
--select c.cto_rut, c.ctd_direccion_v2
--from
--(
--select cto_rut, ctd_direccion_v2, COUNT(*) as cont
--from #CONTACTO_DET_NEW_V0
--where ctd_direccion_v2 is not null
--group by cto_rut, ctd_direccion_v2
--having COUNT(*) > 1
--) c
...
having COUNT(*) > 1
	...
	on b.cto_rut = b.cto_rut
	and b.ctd_direccion_v2 = c.ctd_direccion_v2
where b.CMN_CODIGO is null
*/
...
SELECT CTO_RUT, -- char(10)  NULL,
	...
	--1.698.120 reg 5:20 min
	--1.697.226 reg 7:20 min
	--1.599.187 reg 7:20 min
	--SELECT * FROM #CONTACTO_DET_NEW_V1
