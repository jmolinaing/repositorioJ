...
/*================================================================================================= 
 ...
 DESCRIPCION        : Obtiene listado de la tabla CONTACTO_DET normalizado hacia la tabla CONTACTO_DET_NEW
 --=================================================================================================*/

--GRANT EXECUTE ON dbo.spu_ges_cob_normalizar TO public 
--exec spu_ges_cob_normalizar
-- CONTACTO_DET_NEW: 1704824 REG EN 1:51 MIN
...
BEGIN  
	...
	-- A esta tabla se traspasara el contenido de la tabla CONTACTO_DET con algunos filtros
	...
	-- El contenido de #CONTACTO_DET_NEW_V0 se separara en los 3 conceptos: direccion, email, fono , y se evitaran repeticiones y se guardara en #CONTACTO_DET_NEW_V1, 
	-- al final el contenido de #CONTACTO_DET_NEW_V1 se traspasara a la tabla CONTACTO_DET_NEW
    ...
    BEGIN TRY
			...
			join #CONTACTO_DET_NEW_V0 as b 
				on a.cto_rut = b.cto_rut 
				and a.ctd_correl = b.ctd_correl
			where CHARINDEX('@', b.ctd_email2) < 1
			...
			-- eliminar direcciones iguales pero sin comuna FALTA PULIR
			...
			if (select count(*) from #CONTACTO_DET_NEW_V1) > 0 
			begin
				delete CONTACTO_DET_NEW
			end
